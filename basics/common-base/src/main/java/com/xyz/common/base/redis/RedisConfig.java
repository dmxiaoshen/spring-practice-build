...
//
//    @Bean
//    public RedisMessageListenerContainer container(LettuceConnectionFactory redisConnectionFactory, ThreadPoolTaskExecutor subscriptionExecutor, ThreadPoolTaskExecutor redisTaskExecutor){
...
//
//    @Bean
//    public MessageListenerAdapter listenerAdapter(RedisMessageListenerContainer container, MessageTopicConsumer commentTopicConsumer){
//        MessageListenerAdapter listenerAdapter = new MessageListenerAdapter(commentTopicConsumer,"onMessage");
//        container.addMessageListener(listenerAdapter,new PatternTopic(MessageTopicConsumer.TOPIC));
